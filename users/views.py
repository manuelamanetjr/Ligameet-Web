...
from .forms import UserRegisterForm, UserUpdateForm, ProfileUpdateForm, PlayerForm, VolleyBallForm, BasketBallForm, PhysiclInformation
...
def profile(request):
    if request.method == 'POST':
        ...
        physical_from = PhysiclInformation(request.POST, instance=request.user)
        ...
        physical_from = PhysiclInformation(instance=request.user)
