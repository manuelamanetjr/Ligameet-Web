...
from . import views
from users.views import choose_role, register_user, login_user, get_sports, get_events, get_invitations, update_invitation_status, reset_password_view, payment_success_sub, payment_cancelled_sub
